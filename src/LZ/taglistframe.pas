...
uses
  ...
  Dialogs, VirtualTrees, ComCtrls, ActnList, LCLType,

  uStructs, StdCtrls, ExtCtrls, Menus, CheckLst, Buttons, ActiveX;
...
begin
  if Application.MessageBox(PChar('Delete tag?'), PChar('Confirm'), MB_YESNO) = IDYES then
  begin
